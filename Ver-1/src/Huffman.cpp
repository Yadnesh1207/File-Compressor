...
buildFrequencyMap(const std::vector<unsigned char> &block)
{
...
void collectLengths(int idx, const std::vector<Node> &nodes, uint8_t depth, std::unordered_map<unsigned char, uint8_t> &lengths)
{
...
{
    std::unordered_map<unsigned char, uint8_t>
        lengths;
...
std::unordered_map<unsigned char, HuffCode> buildCanonicalCodes(const std::unordered_map<unsigned char, uint8_t> &lengths)
{
    ...
    std::unordered_map<unsigned char, HuffCode>
        codes;
...
void encodeData(
    std::istream &in,
    BitWriter &w,
    const std::unordered_map<unsigned char, HuffCode> &m)
{
    unsigned char c;
